<template>
    <div class="grandbattle">
        <grand-battle-listing v-for="(id, index) in fighters" :key="id" :fighterId="id" :round="round" :hideLink="hideLinks" :isDuelist="index === 0 && alsoDuel" />
    </div>
</template>
...
import {MASSBATTLE_FIGHTERS, CURRENT_ROUND, CURRENT_ZONE_FIGHT} from '../../state/getters'
